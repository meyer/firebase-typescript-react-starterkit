...
declare namespace GQL {
  ...
  export interface Mutation {
    ...
    readonly goodbye: Scalars['String'];
  }

  export interface MutationGoodbyeArgs {
    name: Scalars['String'];
  }
  ...
  > {
    goodbye?: Resolver<ResolversTypes['String'], ParentType, ContextType, RequireFields<MutationGoodbyeArgs, 'name'>>;
  }
